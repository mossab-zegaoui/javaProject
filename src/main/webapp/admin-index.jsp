                        ...
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                ...
                                <ul class="sidebar-submenu">
                                    <li><a href="WEB-INF/productList.jsp">Product list</a></li>
                                </ul>
                            </li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="" class="btn btn-primary" style="margin-left: 82%">Add product</a>
                            <form action="AdminController" method="post" >
                                <input type="hidden" name="action" value="listProducts">
                                <button class="btn btn-primary" type="submit">List products</button>
                            </form>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="AdminController" method="post">
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-xs" data-original-title="btn btn-danger btn-xs" title="">edit</button>
                                                </form>
                                            </td>
                                            <td>
                                                <form action="AdminController" method="post">
                                                    ...
                                                    <input type="hidden" name="id" value="${product.id}">
                                                    <button type="submit"  class="btn btn-success btn-xs"  data-original-title="btn btn-danger btn-xs" title=""> delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
