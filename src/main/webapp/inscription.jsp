...
<div class="section">
 ...
 <div class="form">
  ...
  <h5>Shop with confidence</h5> 
   ...
   </div> <div class="social"> <ul class="social-icons"> 
   <li><a href="#"><i class="fa fa-facebook"></i></a></li> <li>
   <a href="#"><i class="fa fa-twitter"></i></a></li> <li><a href="#"><i class="fa fa-linkedin"></i></a></li> <li><a href="#"><i class="fa fa-instagram"></i></a></li> </ul> <ul class="terms"> <li><a href="#">Terms</a></li> <li><span class="dots"></span></li> <li><a href="#">Services</a></li> </ul> </div> </div> 
   ...
   <input type="text" placeholder="Login" name="login"> <i class="fa fa-user"></i> 
    ...
    <div class="form-inputs"> 
   <input type="text" placeholder="Nom et Prénom" name="nom"> <i class="fa fa-user"></i> 
   <input type="text" name="inscription" hidden>
   </div>
    <div class="form-inputs"> 
   <input type="email" placeholder="Email" autocomplete='chrome-off' name="email">
    <i class="fa fa-envelope"></i> </div> <div class="form-inputs"> 
    <input id="password_input" class="password-input" autocomplete='chrome-off' type="password" placeholder="Mot de passe" name="motdepasse"> <i class="fa fa-eye" id="password_eye"></i> <p id="random_password" class="random_password"></p> 
    </div> 
